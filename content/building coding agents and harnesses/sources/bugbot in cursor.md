...
-   **GitHub** (including GitHub Enterprise Server): See the [GitHub integration page](/docs/integrations/github)
-   **GitLab** (including GitLab Self-Hosted): See the [GitLab integration page](/docs/integrations/gitlab)
-   **Bitbucket Cloud**: See the [Bitbucket integration page](/docs/integrations/bitbucket)
...
## [CI check statuses](#ci-check-statuses)
...
![Bugbot dashboard](/docs-static/_next/image?url=%2Fdocs-static%2Fimages%2Fbugbot%2Fbugbot-dashboard.png&w=1920&q=75&dpl=dpl_BNsmT9osMojcdwUjLhJY4WPad2sK)

## [Incremental reviews](#incremental-reviews)
...
![Incremental Review setting in the Bugbot dashboard](/docs-static/_next/image?url=%2Fdocs-static%2Fimages%2Fbugbot%2Fincremental-review-setting.png&w=1920&q=75&dpl=dpl_BNsmT9osMojcdwUjLhJY4WPad2sK)
...
## [Run in your agent](#run-in-your-agent)
...
![Running the /review-bugbot skill from the agent input](/docs-static/_next/image?url=%2Fdocs-static%2Fimages%2Fbugbot%2Freview-bugbot-skill.png&w=1920&q=75&dpl=dpl_BNsmT9osMojcdwUjLhJY4WPad2sK)

### [Sync with your pull request](#sync-with-your-pull-request)
...
Bugbot Autofix automatically spawns a [Cloud Agent](/docs/cloud-agent#overview) to fix bugs found during PR reviews.
...
![Bugbot Autofix comment on a PR](/docs-static/_next/image?url=%2Fdocs-static%2Fimages%2Fbugbot%2Fbugbot-autofix-comment.png&w=1920&q=75&dpl=dpl_BNsmT9osMojcdwUjLhJY4WPad2sK)
...
-   [On-demand usage](/docs/models-and-pricing) pricing enabled
-   Storage enabled (not in Legacy Privacy Mode)

### [Billing](#billing)

Autofix uses Cloud Agent credits and is billed at your plan rates. Cloud Agent billing follows your existing [pricing plan](/docs/models-and-pricing).

## [MCP support](#mcp-support)

Bugbot is integrated with your [MCP servers](/docs/mcp) so your AI tools can interact with Bugbot directly. Use the MCP server to provide additional tools to guide Bugbot's review process.

To get started:

1.  Follow the [MCP documentation](/docs/mcp) for MCP server setup instructions.
...
#### [Adding or removing a user](#adding-or-removing-a-user)
...
#### [Example: provisioning users through an internal tool](#example-provisioning-users-through-an-internal-tool)
...
Bugbot pricing changed with the May 2026 pricing update. See the [announcement blog post](https://cursor.com/blog/may-2026-bugbot-changes) for background. If you're still on the old seat-based plan, see [legacy Bugbot pricing](/docs/bugbot/legacy-pricing).
...
-   [GitHub Enterprise Server](/docs/integrations/github#setup)
-   [GitLab Self-Hosted](/docs/integrations/gitlab#setup)
